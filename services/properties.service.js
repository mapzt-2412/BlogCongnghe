...
class PropertiesService {
  ...
  getArticleByUser(token, page) {
    return http.get(
      `/users/my-articles?page=${page}&limit=${DEFAULT_PAGE_SIZE}`,
      { headers: { Authorization: "Bearer " + token } }
    );
  }
  getArticleByUserId(id, page) {
    return http.get(
      `/users/${id}/list-articles-by-user?page=${page}&limit=${DEFAULT_PAGE_SIZE}`
    );
  }
  ...
  getStory(param, token) {
    ...
    return instanceNoSpiner.get(`/articles/story?${params}`, {
      headers: { Authorization: "Bearer " + token },
    });
  }
  ...
  createArticle(data, token) {
    return http.post("/articles/create-article", JSON.stringify(data), {
      headers: { Authorization: "Bearer " + token },
    });
  }
  createDraft(data, token) {
    return instanceNoSpiner.post("/drafts/create-draft", JSON.stringify(data), {
      headers: { Authorization: "Bearer " + token },
    });
  }
  updateArticle(data, token) {
    return http.patch("/articles/update-article", JSON.stringify(data), {
      headers: { Authorization: "Bearer " + token },
    });
  }
  updateDraft(data, token) {
    return instanceNoSpiner.put("/drafts/update-draft", JSON.stringify(data), {
      headers: { Authorization: "Bearer " + token },
    });
  }
  updateUserInfo(data, token) {
    return instanceNoSpiner.put("/users/update-info", JSON.stringify(data), {
      headers: { Authorization: "Bearer " + token },
    });
  }
  deleteArticle(data, token) {
    return http.delete("/articles/delete-article", {
      data: JSON.stringify(data),
      headers: { Authorization: "Bearer " + token },
    });
  }
  deleteDraft(data, token) {
    return http.delete("/drafts/delete-draft", {
      data: JSON.stringify(data),
      headers: { Authorization: "Bearer " + token },
    });
  }
  ...
  likeArticle(data, token) {
    return instanceNoSpiner.post(`/users/interactive`, JSON.stringify(data), {
      headers: { Authorization: "Bearer " + token },
    });
  }
  commentArticle(data, token) {
    return instanceNoSpiner.post(`/users/comment`, JSON.stringify(data), {
      headers: { Authorization: "Bearer " + token },
    });
  }
  getComment(id, token) {
  ...
  getFollowed(id, token) {
    return http.get(`/users/followed-by-user/${id}`, {
      headers: { Authorization: "Bearer " + token },
    });
  }
  getFollowing(id, token) {
    return http.get(`/users/following-by-user/${id}`, {
      headers: { Authorization: "Bearer " + token },
    });
  }
  ...
  getBookMark(token) {
    return http.get(`/users/bookmark`, {
      headers: { Authorization: "Bearer " + token },
    });
  }
  sendReport(data, token) {
    return http.post(`/users/report-article`, JSON.stringify(data), {
      headers: { Authorization: "Bearer " + token },
    });
  }
  sendReportUser(data, token) {
    return http.post(`/users/report-user`, JSON.stringify(data), {
      headers: { Authorization: "Bearer " + token },
    });
  }
  search(keyword) {
  ...
  createMessage(data, token) {
    return instanceNoSpiner.post(`/users/message`, JSON.stringify(data), {
      headers: { Authorization: "Bearer " + token },
    });
  }
  getMessage(token) {
    return http.get(`/users/messag-users`, {
      headers: { Authorization: "Bearer " + token },
    });
  }
  getMessageByUser(data, token) {
    return http.get(`/users/message/${data}`, {
      headers: { Authorization: "Bearer " + token },
    });
  }
  getTopicByScore() {
